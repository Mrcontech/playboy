      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 lg:gap-8">
          ...
          <section className="bg-black border-2 border-green-500 rounded-xl p-6">
            ...
            <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-3 sm:gap-4 justify-items-center">
